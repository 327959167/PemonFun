window.onload = function( ) {
  //获取picture的ul列表
  var pic_ul = document.querySelector( '.container1 .picture' )
    //获取picture的li节点
  var pic_li = document.querySelectorAll( '.container1 .picture .item' )
    //获取point的ul列表
  ...
  function init( ) {
    //获取第一张图片
    var first_pic = document.querySelector(
        '.container1 .picture .item:first-of-type'
      )
      //获取最后一张图片
    var last_pic = document.querySelector(
        '.container1 .picture .item:last-of-type'
      )
      //复制第一张图片
  ...
  document.querySelector( '.container1' ).onmouseenter = function( ) {
    btn[ 0 ].style.display = 'block'
    btn[ 1 ].style.display = 'block'
    stop( )
  }
  document.querySelector( '.container1' ).onmouseleave = function( ) {
